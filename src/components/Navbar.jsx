...
export default function Navbar() {
  ...
  return (
    <nav ref={navRef} className="fixed inset-x-0 top-0 z-40 bg-white/20 backdrop-blur border-b-2 border-white flex items-center justify-between shadow-[0_2px_2px_0_rgba(0,0,0,0.08)]" style={{height: 60}}
      onLoadCapture={() => {
        try {
